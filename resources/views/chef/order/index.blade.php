                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                            ...
                                            <tr>
                                                ...
                                                <th>{{ trans('home.meals') }}</th>
                                                <th>{{ trans('home.created_at') }}</th>
                                                <th>{{ trans('home.protein') }}</th>
{{--                                                <th>{{ trans('home.actions') }}</th>--}}
                                            ...
                                            @foreach ($orders as $order)
                                                <tr>
                                                    <td>#{{ $order->id }}</td>
                                                    <td>#{{ $order->user->id }}</td>
                                                    <td>{{ (lang() == 'ar' ? $order->meal->name_ar : $order->meal->name_en) }}</td>
                                                    <td>{{ $order->date_of_order }}</td>
                                                    <td>{{ $order->protein }}</td>
{{--                                                    <td>--}}
{{--                                                        <img src="{{ getFile($order->img) }}"--}}
...
{{--                                                                                    <option--}}
{{--                                                                                        value="{{ $package->id }}" {{ ($package->id == $order->meal_type->id) ? 'selected' : '' }} >--}}
...
{{--                                                <div class="modal fade" id="show{{ $order->id }}" tabindex="-1"--}}
{{--                                                     role="dialog"--}}
{{--                                                     aria-labelledby="exampleModalLabel" aria-hidden="true">--}}
{{--                                                    <div class="modal-dialog modal-lg" role="document">--}}
{{--                                                        <div class="modal-content">--}}
...
{{--                                                                            :</label>--}}
{{--                                                                        <input type="text" class="form-control"--}}
{{--                                                                               value="{{ (lang() == 'ar') ? $order->meal_type->name_ar : $order->meal_type->name_en }}"--}}
