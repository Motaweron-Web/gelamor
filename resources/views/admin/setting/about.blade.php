        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('setting.about_update') }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="about_ar" id="editor1"
                                              class="form-control">{{ $setting->about_ar }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="about_en" id="editor2"
                                              type="text">{{ $setting->about_en }}</textarea>
                                </div>
                            </div>
                        </div>
