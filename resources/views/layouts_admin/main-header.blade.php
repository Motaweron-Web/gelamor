...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    @if(Auth::guard('admin')->check())
        <div class="text-left navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="{{ route('admin.home') }}">
                <h1><span style="color: #28a745">G</span>elamor</h1>
            </a>
    ...
    @else
        <div class="text-left navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="{{ route('chef.home') }}">
                <h1><span style="color: #28a745">G</span>elamor</h1>
            </a>
            <a class="navbar-brand brand-logo-mini" href="{{ route('chef.home') }}">
                <h1><span style="color: #28a745">G</span>elamor</h1>
            </a>
        </div>
    @endif
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right" style="width: 200px;">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="https://topbusiness.io/contact3.html"><i
                        class="text-warning ti-user"></i>{{ trans('home.need_help') }}</a>
